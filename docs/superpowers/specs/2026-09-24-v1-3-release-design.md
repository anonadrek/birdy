...
7. **Artprofil** (`SpeciesProfileScreen`): `PhotoHero` (familj, namn, latinskt namn, piller: stämplad + antal fynd, abundans, IUCN), arksida med beskrivning, flyttningstext och foton. (Säsongsremsan ströks 2026-09-24: artdatan har `present` alla tolv månader för alla 839 arter, så remsan skulle se likadan ut för varje art.) Premium-teasern behålls men med sann copy (§5.4).
