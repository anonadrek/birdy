...
You don't need cell coverage in the field — just battery.

**PRIVACY-FIRST**
No accounts. No advertisers. No tracking. Camera frames are processed
on-device and discarded immediately. Saved photos live in the app's
private folder on your phone — uninstall removes everything.

— Birdy is made by a solo developer in Sweden for field birders,
...
ornithology, field birder, birding journal, bird tracker
