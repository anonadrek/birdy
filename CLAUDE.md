...
| i2a | Android TFLite→LiteRT (16 KB-fix) | `litert:1.4.1` (foto-`.so` ✅), 16 KB flex-swap (audio-`.so` ✅, SHA-256-pinnad), classifier-first-run-fix, vC126-AAB byggd + alignment-grön | 🔄 kod klar (2026-07-18); kvar: Albin device-verify (foto första-försöket + audio + live-scan) → Play-upload |
