...
class AttachLocationTest {
    ...
    @Test
    fun liveImageAttaches() = assertEquals(true, shouldAttachLocation(ScanSource.Image("/f.jpg", cls, live = true)))

    @Test
    fun galleryImageDoesNotAttach() = assertEquals(false, shouldAttachLocation(ScanSource.Image("/f.jpg", cls, live = false)))
