...
- **v2 iOS-spåret — hela appkärnan KODKLAR (2026-07-07 → 2026-08-16):** i0 (miljö/simulator-boot) ✅, i1 (uppslagsverk + dagbok, sim-verifierad) ✅, i2b (foto-ID, numerisk paritet mot Android) + i2c (live-kamera = Milestone 1-kod) + **i3 (ljud-ID, BirdNET + Flex på device)** — alla kodklara + fullt review:ade från samma KMP-kodbas. Kvar före release: Albins sim-/device-verifygrindar (kräver fysisk iPhone) → i4 paritets-svep (karta/notiser/PDF) → i5 StoreKit 2 (kräver Apple Developer-enrollment) → i6 App Store. **Checklista med ägare + estimat: `docs/ios-release-checklist.md`.** OBS: Asien-content-delen av v2 är inte påbörjad — iOS-launchen sker på Android-v1.2-paritet.
